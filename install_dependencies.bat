@echo off
REM Script de instalação das dependências para todos os chatbots
REM Autor: André Kroetz Berger

echo ======================================================
echo INSTALACAO DAS DEPENDENCIAS - PROJETO CHATBOTS
echo ======================================================
...
echo.
echo Instalando dependencias para dataset e LLM...
...
echo - Comparacao LLM: python chatbot_llm/llm_comparison.py
echo.
